...
public sealed class SecurityCategoriesViewModelTests
{
    ...
    public async Task Initialize_Loads_Categories()
    {
        ...
        {
            if (req.Method == HttpMethod.Get && req.RequestUri!.AbsolutePath == "/api/security-categories")
            {
        ...
        var vm = new SecurityCategoriesViewModel(CreateSp(), new TestHttpClientFactory(client));
    ...
    {
        var vm = new SecurityCategoriesViewModel(CreateSp(authenticated: false), new TestHttpClientFactory(CreateHttpClient(_ => new HttpResponseMessage(HttpStatusCode.NotFound))));
    ...
    {
        var vm = new SecurityCategoriesViewModel(CreateSp(), new TestHttpClientFactory(CreateHttpClient(_ => new HttpResponseMessage(HttpStatusCode.NotFound))));
