...
{
    /// <summary>
    /// Provides endpoints to upload, list, download and manage attachments and attachment categories for the current user.
    /// The controller performs parameter validation and delegates business operations to <see cref="IAttachmentService"/> and <see cref="IAttachmentCategoryService"/>.
    /// </summary>
    [ApiController]
    ...
    public sealed class AttachmentsController : ControllerBase
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="AttachmentsController"/>.
        /// </summary>
        /// <param name="service">Attachment service handling storage and retrieval.</param>
        /// <param name="cats">Attachment category service.</param>
        /// <param name="current">Current user context service.</param>
        /// <param name="logger">Logger.</param>
        /// <param name="options">Attachment upload configuration options.</param>
        /// <param name="localizer">Localizer for user-facing messages.</param>
        /// <param name="dp">Data protection provider to generate short-lived download tokens.</param>
        ...
        /// <summary>
        /// Lists attachments for a given entity owned by the current user with pagination and optional filtering.
        /// </summary>
        /// <param name="entityKind">Attachment entity kind (see <see cref="AttachmentEntityKind"/>).</param>
        /// <param name="entityId">Entity identifier the attachments belong to.</param>
        /// <param name="skip">Pagination offset.</param>
        /// <param name="take">Pagination page size (capped).</param>
        /// <param name="categoryId">Optional category filter.</param>
        /// <param name="isUrl">Optional filter for URL attachments.</param>
        /// <param name="q">Optional search query.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>PageResult of <see cref="AttachmentDto"/>.</returns>
        ...
        /// <summary>
        /// Uploads a file or creates an URL reference for an attachment on the specified entity.
        /// </summary>
        /// <param name="entityKind">Attachment entity kind.</param>
        /// <param name="entityId">Entity identifier.</param>
        /// <param name="file">Multipart file (optional if url is provided).</param>
        /// <param name="categoryId">Optional category id.</param>
        /// <param name="url">Optional URL to create a reference attachment instead of uploading binary content.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <param name="role">Optional attachment role (e.g. Symbol).</param>
        /// <returns>Attachment DTO of the uploaded or created attachment.</returns>
        ...
        /// <param name="validSeconds">Token validity in seconds (clamped).</param>
        /// <returns>200 OK with token or 404 if attachment not found / not owned.</returns>
        ...
        /// <summary>
        /// Downloads the attachment binary content. If an authenticated user calls, ownership is verified by the service.
        /// Anonymous requests must present a valid short-lived token generated by <see cref="CreateDownloadTokenAsync"/>.
        /// </summary>
        /// <param name="id">Attachment identifier.</param>
        /// <param name="token">Optional short-lived download token for anonymous access.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>File stream result or 404 if not found/unauthorized.</returns>
        ...
        /// <summary>
        /// Request to update category assignment for an attachment.
        /// </summary>
        public sealed record UpdateCategoryRequest(Guid? CategoryId);

        /// <summary>
        /// Request to update core metadata of an attachment.
        /// </summary>
        public sealed record UpdateCoreRequest(string? FileName, Guid? CategoryId);

        /// <summary>
        /// Updates core metadata of an attachment (file name, category).
        /// </summary>
        /// <param name="id">Attachment identifier.</param>
        /// <param name="req">Update request containing new file name and/or category id.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>NoContent on success or NotFound if attachment missing.</returns>
        [HttpPut("{id:guid}")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        ...
        /// <summary>
        /// Updates only the category of an attachment.
        /// </summary>
        ...
        /// <summary>
        /// Lists attachment categories for the current user.
        /// </summary>
        [HttpGet("categories")]
        ...
        /// <summary>
        /// Request payload to create a new attachment category.
        /// </summary>
        public sealed record CreateCategoryRequest([Required, MinLength(2)] string Name);
        /// <summary>
        /// Request payload to update an attachment category name.
        /// </summary>
        public sealed record UpdateCategoryNameRequest([Required, MinLength(2)] string Name);

        /// <summary>
        /// Creates a new attachment category for the current user.
        /// </summary>
        /// <param name="req">Category create request.</param>
        /// <param name="ct">CancellationToken.</param>
        /// <returns>201 Created with created category or 400 on validation error.</returns>
        [HttpPost("categories")]
