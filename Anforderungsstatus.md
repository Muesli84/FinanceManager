...
| FA-UI-001   | Suchfeld in Listen                                              | UI: Teilweise vorhanden                          | ~      |
| FA-UI-002   | Live-Filterung                                                  | UI: Teilweise vorhanden                          | ~      |
| FA-API-001  | Web API für alle Entitäten                                      | Controller für Konten, Kontakte, Auszüge         | ✔      |
| FA-API-002  | Suchkriterien für API                                           | Teilweise vorhanden                              | ~      |
